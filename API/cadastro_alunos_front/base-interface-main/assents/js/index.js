        ...
        //API GET
        //chama a API e pega os dados
    fetch('http://localhost:8080/api/aluno', { //chama a API
      method: 'GET', //metodo de pegar informçao
      headers: {
        'Content-Type': 'application/json' //dizendo que o conteudo é JSON
      },
    })
  ...
  function addlinha(dadosAPI){
      ...
      dadosAPI.forEach(element => {   //repetição da quantidade de dados que vieram da API
