...
@RequestMapping("/saida") // URL base para esse controller (ex.: localhost:8080/saida)
...
public class SaidaController {
    ...
    @GetMapping("/{id_saida}")
    public ResponseEntity<Saida> buscarPorId(@PathVariable Long id_saida) {
    ...
    public void deletar(@PathVariable Long id_saida) {
